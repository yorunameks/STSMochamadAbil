        ...
        <h1 class="h3 mb-4 text-gray-800">Edit Data Barang</h1>
            ...
            <form class="user" method="POST">
                ...
                <div class="form-group">
                    <input type="text" class="form-control form-control-user" placeholder="Kode Barang" name="kode_barang" value="<?php echo $barang['kode_brg']; ?>">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control form-control-user" placeholder="Nama Barang" name="nama_barang" value="<?php echo $barang['nama_brg']; ?>">
                </div>
                <div class="form-group">
